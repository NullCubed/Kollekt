...
def filldb():
    ...
    db.session.add(CollectionItem("Moses 300", "A pair of vegan leather Moses 300s", 1))
    db.session.add(CollectionItem("Better Call Saul 750", "My lawyers shoes", 1))
    db.session.add(CollectionItem("A Fancy Rolex", "My dad's Rolex", 2))
    db.session.commit()
